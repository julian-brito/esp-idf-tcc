...
#define MCPWM_CLK_PRESCL 159       //Mudança feita para permitir trabalhar com baixa frequências
#define TIMER_CLK_PRESCALE 99      ////Mudança feita para permitir trabalhar com baixa frequências
